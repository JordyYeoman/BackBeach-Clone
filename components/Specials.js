const Specials = () => {
  return (
    <section className="relative Fredericka px-4 py-4 background-img1 mt-8 specialsBanner">
      ...
      <div className="sourceSans relative z-10">
        <span>
          <p className="text-gray-800 text-lg">
            Join us to celebrate your mum this Mother's Day. Breakfast and Lunch
            are pretty full but we are still taking dinner bookings so yo....
          </p>
        </span>
