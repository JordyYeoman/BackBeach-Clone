const Reviews = () => {
  return (
    <div className="Fredericka text-2xl text-white flex flex-col bg-center justify-center reviews py-32 items-center">
      ...
      <div className="w-full flex flex-col justify-end items-end xl:max-w-screen-xl px-4 md:px-16 lg:px-32">
        <h2 className="text-5xl md:text-4xl text-black">Happy Customers</h2>
